...
<section class="navigation">
    <div class="nav-container">
        <div class="brand" style="">
            ...
            <img id="logoElementum2" class="hide" src="{{ URL::to('/') }}/images/logocolor.png"
                 alt="Editorial Elementum logo">
        </div>
        <nav>
            <div class="nav-mobile"><a id="nav-toggle" href="#!"><span><i style="font-size:2em; color:#00aa93;"
                                                                          class="fas fa-align-justify"></i></span></a>
            </div>
            <ul class="nav-list" id="nav-bar">
                <li style="border-left: 1px solid white;">
                    <a id="nosotros" class="nav_link " href="{{route('nosotros.elementum')}}">Nosotros</a>
                </li>
                <li>
                    <a id="colecciones" class="nav_link" href="{{route('libros.colecciones')}}">Colecciones</a>
                </li>
                <li>
                    <a id="autores" class="nav_link" href="{{route('autores.libros')}}">Autores</a>
                </li>
                <li>
                    <a id="actividades" class="nav_link" href="{{route('elementario.elementum')}}">Actividades</a>
                </li>
                <li>
                    <a id="contacto" class="nav_link" href="{{route('contacto.elementum')}}">Contacto</a>
                </li>
                <li style="border-right: 1px solid white;">
                    <a id="blog" class="nav_link" href="{{ route('blog.elementum') }}">Blog</a>
                </li>
                <li id="iconos" class=""
                    style="padding-top: 15px; padding-left: 15px; padding-bottom: 24px; border-bottom: 1px solid white;">
                    <i onclick="openInNewTab('{{ $elementum->facebook }}')"
                       class="fab social_icons fa-facebook-f link"></i>
...
<footer id="foter">
    <div id="footer-container" class="container">
        <div class="row">
            ...
            <div id="footer-links" class="col-md-6 align-content-right"
                 style="align-content: right; text-align: right;">
                <a id="fb_link" target="_blank" href="{{ $elementum->facebook }}"><i
                            style="font-size: 15px; padding-top:6px;height: 30px; width: 30px;"
                            class="fab fa-facebook-f social_icons link footer"></i></a>
                <a id="tw_link" target="_blank" href="{{ $elementum->twitter }}foo"><i
                            style="font-size: 15px; padding-top:6px;height: 30px; width: 30px;"
                            class="fab fa-twitter social_icons link footer"></i></a>
                <a id="insta_link" target="_blank" href="{{ $elementum->insta }}"><i
                            style="font-size: 15px; padding-top:6px;height: 30px; width: 30px;"
                            class="fab fa-instagram social_icons link footer"></i></a>
                <br>
                Teléfono <br>
...
<script>
    ...
    function highlightCurrentLink() {
        let navItems = $("[class*='nav_link']");
        let currentPath = window.location.href;
        for (let i = 0; i < navItems.length; i++) {
            if (navItems[i].href === currentPath) {
                $(navItems[i]).addClass("active-link")
            } else {
                let found = currentPath.split("/").find(function (element) {
                    return element === "blog";
                });
                if(!(found === undefined)){
