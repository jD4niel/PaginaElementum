...
<div class="container">
    <div class="row">
        <button id="show_button" class="btn-hover color-1" onclick="upload_image('contacto')">Guardar imagen</button>
        <div class="tab-banner-image" onclick="triggerInputFile('input_file_img',true)">
            <img id="nosotros_img" src="{{ asset('images/tabs_banners') }}/{{ $contacto->image }}" alt="imagen-contacto">
