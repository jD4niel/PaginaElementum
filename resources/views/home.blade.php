@extends('layouts.app')
@section('content')
<div class="container-fluid text-center" style="margin: 2rem 0">
    ...
    <div class="row text-right">
        @if(Auth::user()->role_id == 2 || Auth::user()->role_id == 3)
        <a href="{{route('control.gral')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #3d7fcb;">
                <div class="card-body">
        ...
        @endif
        <a href="{{route('entradas')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #cb304f;">
                <div class="card-body">
        ...
        <a href="{{route('autor-entradas')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style=" margin:10px;background-color: #a736bb;">
                <div class="card-body">
        ...
        @if(Auth::user()->role_id == 2 || Auth::user()->role_id == 3)
        <a href="{{route('crear.autor')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #bb2d5e;">
                <div class="card-body">
        ...
        <a href="{{route('editarpagina')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #17bb3a;">
                <div class="card-body">
        ...
        <a href="{{route('subirpdf')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #13a597;">
                <div class="card-body">
        ...
        <a href="{{route('crear.libro')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #86921f;">
                <div class="card-body">
        ...
        @endif
        <a href="{{route('elementario.index.controller')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #BB4F24;">
                <div class="card-body">
                    <h2 class="card-title" style="z-index: 50;">Control</h2>
        ...
        @if(Auth::user()->role_id == 2 || Auth::user()->role_id == 3)
        <a href="{{route('control.gral')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #3f3fbb;">
                <div class="card-body">
        ...
        <a href="{{route('admin.portada')}}" class="a-free col-xs-12 col-sm-12 col-md-6 col-lg-4" target="_blank">
            <div class="card" style="margin:10px;background-color: #a3abbb;">
                <div class="card-body">
